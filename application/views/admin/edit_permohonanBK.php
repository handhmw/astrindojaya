							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input id="tgl_lahir" type="text" name="waktu_pmhn" class="form-control" value="<?php echo set_value('waktu_pmhn', $kry_->waktu_pmhn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<select class="form-control" id="dasar_permohonan" name="dasar_permohonan_pmhn" value="<?php echo set_value('dasar_permohonan_pmhn', $kry_->dasar_permohonan_pmhn); ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<!-- <textarea value="<?php echo $kry_->ringkasan_tugas_pmhn; ?>" class="form-control" rows="5" cols="30" name="ringkasan_tugas_pmhn"><?php echo $kry_->ringkasan_tugas_pmhn; ?></textarea> -->
											<!-- <textarea class="form-control" rows="5" cols="30" name="ringkasan_tugas_pmhn"><?php echo set_value('ringkasan_tugas_pmhn', $kry_->ringkasan_tugas_pmhn); ?></textarea>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<!-- <textarea value="<?php echo $kry_->keterampilan_pmhn; ?>" class="form-control" rows="5" cols="30" name="keterampilan_pmhn"><?php echo $kry_->keterampilan_pmhn; ?></textarea> -->

											<!-- <textarea class="form-control" rows="5" cols="30" name="keterampilan_pmhn"><?php echo set_value('keterampilan_pmhn', $kry_->keterampilan_pmhn); ?></textarea>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
											...
											<!-- <textarea class="form-control" rows="5" cols="30" name="office_equipment_pmhn"><?php echo set_value('office_equipment_pmhn', $kry_->office_equipment_pmhn); ?></textarea>
											<?php echo form_error('office_equipment_pmhn'); ?> -->
