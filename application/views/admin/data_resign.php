						...
						<div class="col-lg-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <a href="<?php echo base_url() ?>admin/print_resign" class="btn btn-xs btn-default" role="button" title="Print Data">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<?php echo base_url();?>admin/upload_resign/" enctype="multipart/form-data" method="post">
