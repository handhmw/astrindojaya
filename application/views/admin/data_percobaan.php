						...
						<div class="col-lg-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <a href="<?php echo base_url() ?>admin/print_percobaan" class="btn btn-xs btn-default" role="button" title="Print Data">
                                    <i class="fa fa-print"></i><span> Print</span></a>
                                    <a href="<?=base_url('report_percobaan/report_manual')?>" class="btn btn-xs btn-default" role="button" title="Print Manual">
