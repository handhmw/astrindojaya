										...
										<div class="card-body">
											<?php echo form_open('admin/save_karyawan', ['class' => 'form-horizontal', 'method' => 'post']); ?>
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" name="nik_kry" value="<?php echo set_value('nik_kry'); ?>">
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<input id="tgl_lahir" type="text" name="tgl_lahir_kry" class="form-control">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<textarea class="form-control" rows="5" cols="30" name="alamat_kry" ></textarea>
													</div>
												</div>
												<div class="form-group row">
													<label for="" class="col-sm-3 col-form-label">Telpon Rumah</label>
													<div class="col-sm-6">
													<input type="text" class="form-control" name="tlp_rumah_kry" value="<?php echo set_value('tlp_rumah_kry'); ?>">
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
													<input type="text" class="form-control" name="no_hp_kry" value="<?php echo set_value('no_hp_kry'); ?>">
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<input id="tgl_masuk" type="text" name="tgl_masuk_kry" class="form-control">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" name="email_kry" value="<?php echo set_value('email_kry'); ?>">
