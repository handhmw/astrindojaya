									...
									<div class="card mb-3">
										...
										<div class="card-body">
											...
											<div class="form-group row">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" name="nik_cb" value="<?php echo set_value('nik_cb', $karyawan->nik_cb); ?>">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<select class="form-control" name="jenis_cb">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<textarea value="<?php echo $karyawan->catatan_hr_cb; ?>" class="form-control" rows="5" cols="30" name="catatan_hr_cb">
													<?php echo $karyawan->catatan_hr_cb; ?></textarea>
												</div>
											</div>
											<div class="form-group row">
												<label for="" class="col-sm-3 col-form-label">Catatan Atasan Langsung</label>
												<div class="col-sm-6">
													<textarea value="<?php echo $karyawan->catatan_atasan_cb; ?>" class="form-control" rows="5" cols="30" name="catatan_atasan_cb">
													<?php echo $karyawan->catatan_atasan_cb; ?></textarea>
												</div>
											</div>
											<br>
											<div class="form-group row">
