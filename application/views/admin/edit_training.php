									...
									<div class="card mb-3">
										...
										<?php echo form_open('admin/update_training/'.$kry->id_tr, ['class' => 'form-horizontal', 'method' => 'post']); ?>
											...
											<label for="nama_pemohon" class="col-sm-3 col-form-label">NIK</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="nik_pemohon_tr" value="<?php echo set_value('nik_pemohon_tr', $kry->nik_pemohon_tr); ?>">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<input type="text" name="biaya_tr" class="form-control" value="<?php echo set_value('biaya_tr', $kry->biaya_tr); ?>">
