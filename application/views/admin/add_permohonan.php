											...
											<?php echo form_open('admin/save_permohonan', ['class' => 'form-horizontal', 'method' => 'post']); ?>
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														...
														<?php echo form_error('status_rekrutmen_pmhn'); ?>
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<textarea class="form-control" rows="5" cols="30" name="ringkasan_tugas_pmhn" value="<?php echo set_value('ringkasan_tugas_pmhn'); ?>"></textarea>
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
													<select class="form-control" name="jk_pmhn" value="<?php echo set_value('jk_pmhn'); ?>"><?php echo form_error('jk_pmhn'); ?>
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
													<select class="form-control" name="pendidikan_pmhn" value="<?php echo set_value('pendidikan_pmhn'); ?>"><?php echo form_error('pendidikan_pmhn'); ?>
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														<textarea class="form-control" rows="5" cols="30" name="office_equipment_pmhn"></textarea>
